# -*- coding: utf-8 -*-
"""
Created on Sat Jun 13 20:41:41 2015
@author: liuchang
"""
...
pygame.display.set_caption("pie game - press 1,2,3,4")
# None默认的字体
...
while True:
    ...
    screen.blit(textImg2, (x + radius / 2 - 20, y - radius / 2))
    ...
    # draw which piece??
    if piece1:
        start_angle = math.radians(90)  # 90度转弧度
        end_angle = math.radians(180)
        pygame.draw.arc(screen, color, position, start_angle, end_angle, width)
        pygame.draw.line(screen, color, (x, y), (x, y - radius), width)
        pygame.draw.line(screen, color, (x - radius, y), (x, y))
    if piece2:
