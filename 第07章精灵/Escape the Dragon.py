...
class MySprite(pygame.sprite.Sprite):
    ...
    def load(self, filename, width, height, columns):
        ...
        :param width: 精灵表中每一帧的宽度。
        :param height: 精灵表中每一帧的高度。
...
# dragon.load("resource/dragon_0.png", 260, 150, 3)
dragon.load("resource/飞龙.png", 256 // 4, 256 // 4, 4)
dragon.position = 100, 230
group.add(dragon)

# 创建玩家
player = MySprite(screen)
# player.load("resource/caveman.png", 50, 64, 8)
player.load("resource/法师.png", 128 // 4, 192 // 4, 4)
...
arrow.load("resource/arrow.png", 239, 75, 1)
