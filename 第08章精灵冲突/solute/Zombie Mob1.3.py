...
velocity_keys = [lambda vel: (0, -vel),
                 lambda vel: (vel, -vel),
                 lambda vel: (vel, 0),
                 lambda vel: (vel, vel),
...
def calc_velocity(direction, vel=1.0):
    ...
    """
    velocity = Point(0, 0)
    velocity.x, velocity.y = velocity_keys[direction](vel)
    return velocity


reverse_keys = {0: 4, 1: 5, 2: 6, 3: 7,
                4: 0, 5: 1, 6: 2, 7: 3}


# 转向
def reverse_direction(sprite):
    sprite.direction = reverse_keys[sprite.direction]


event_keys = {K_w: 0, K_UP: 0, K_d: 2, K_RIGHT: 2, K_s: 4, K_DOWN: 4, K_x: 4, K_a: 6, K_LEFT: 6,
              K_q: 7, K_e: 1, K_z: 5, K_c: 3
              }
